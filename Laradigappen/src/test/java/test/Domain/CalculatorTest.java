...
public class CalculatorTest {
    ...
    public void formula1() {
        String f = "2*2";
        assertEquals(4,calc.calculate(f));
    }
    ...
    public void formula3() {
        String f = "5*(1+2)+4";
        assertEquals(19,calc.calculate(f));
    }
    
    @Test
    public void formula4() {
        String f = "((1+2)*(3+4)+5)*6";
        assertEquals(156,calc.calculate(f));
    }
    
    @Test
    public void formula5() {
        String f = "123*456*789";
        assertEquals(44253432,calc.calculate(f));
    }
    
    @Test
    public void formula6() {
        String f = "2-2";
        assertEquals(0,calc.calculate(f));
    }
    
    @Test
    public void formula7() {
        String f = "5*(1+2)-4";
        assertEquals(11,calc.calculate(f));
    }
    ...
    public void formula9() {
        String f = "2/2";
        assertEquals(1,calc.calculate(f));
    }
